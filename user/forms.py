...
class RegForm(forms.Form):
	...
	def clean(self):
		...
		verfication_code = self.cleaned_data.get('verification_code', '')
		if not (code != '' and code == verfication_code):
...
class ChangeNicknameForm(forms.Form):
	...
	def clean_nicknane_new(self):
		nickname_new = self.clean_nicknane_data.get('nickname_new','').strip()
		if nickname_new == '':
